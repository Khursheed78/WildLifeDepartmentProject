      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">  Offience Decision</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title"> Offience Decision</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Offence Code</label>
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Holder Name</label>
                     ...
                     <div class="col-md-5">
                      ...
                      <div class="col-md-4">
                         <select name="select" id="select" class="form-control">
                        <option value="1">Please Select Offense Type</option>
                      ...
                      <div class="row">
                       ...
                       <div class="col-md-8">
                        <div class="form-group">
                          <label class="bmd-label-floating">Compounded/Decided by Court </label>
                          <input  id="s2"  class="form-control">
                          <span id="n2" class="text-danger"></span>
                        </div>
                      </div> 
