            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Employee Deputation</h4>
                ...
                <div class="card-body">
                  <form action="#" onsubmit="return Validation()" method="post">
                    <div class="row mt-2 mb-3">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Deputation Number</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">To Department</label>
                    ...
                    <div class="row mt-4">
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input id="s6" type="Date" class="form-control">
