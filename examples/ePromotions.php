            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Employee Promotions</h4>
                ...
                <div class="card-body">
                  <form action="#" method="post" onsubmit="return Validation()">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">From Designation</label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">To Designation</label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">From BPS</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">To BPS</label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Promotion Number</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Acting</label>
  ...
  <script type="text/javascript">
       function  Validation()
    {
      ...
      return false;
       ...
       if (isNaN(u7)) {
      document.getElementById('n7').innerHTML="* Please use only digit";
      return false;
