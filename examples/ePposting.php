            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Employee Service History</h4>
                ...
                <div class="card-body">
                  <form action="#" method="post" onsubmit="return Validation()">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Service Status</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Place of Duty</label>
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          <label class="bmd-label-floating">Running Basic Pay</label>
                        ...
                        <div class="form-group">
                          ...
                          <input id="s7" type="Date" class="form-control">
...
// Validation of form
    ...
    function  Validation()
    {
      ...
      document.getElementById('n1').innerHTML="* Please use only digit";
      return false;
      ...
      return false;
       ...
       if (isNaN(u6)) {
      document.getElementById('n6').innerHTML="* Please use only digit";
      return false;
