            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">  Protected Areas</h4>
                ...
                <div class="card-body">
                  <form>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Type of Protected Area</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Area in Hectors</label>
                          <input id="s3" type="email" class="form-control">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Location(Division)</label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Longitude/Latitude</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Geographical Location</label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Key Wildlife</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">General Faena</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">General Flora</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Faena Specie</label>
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Flora Specie</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Habitat Type</label>
 ...
 <!--  <div class="fixed-plugin">
  ...
  <script>
    ...
    function  Validation()
    {
      ...
      document.getElementById('n2').innerHTML="* Please select date";
      return false;
