                ...
                <div class="card-body">
                  <form action="#" method="post" onsubmit="return Validation()">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Transfer Order Number</label>
                          <input id="s1" type="number" class="form-control">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">From Department</label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">To Project</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">From Station</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">To Station</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Worked From</label>
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input id="s9" type="Date" class="form-control">
