            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">  License Type</h4>
                ...
                <div class="card-body">
                  <form>
                      ...
                      <div class="col-md-3">
                        ...
                        <option value="1">License Type</option>
                         <option value="2">Fresh</option>
                         <option value="3">Renewal<small class="ml-3">(if renewal show previous serial number and expiry date)</small></option>
                        </select>                    
                        </div>
                        <div class="col-md-3">
                         <select name="select" id="select" class="form-control">
                      ...
                      <div class="col-md-3">
                         <select name="select" id="select" class="form-control">
                        <option value="1">Select Possession</option>
                        ...
                        <div class="col-md-3">
                         <select name="select" id="select" class="form-control">
                        <option value="1">Select Trapping</option>
                      ...
                      <div class="col-md-4">
                         <select name="select" id="select" class="form-control">
                        <option value="1">Select Dealing</option>
                         <option value="2">Quail Partidge</option>
