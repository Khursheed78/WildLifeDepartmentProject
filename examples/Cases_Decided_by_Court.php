            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title"> Cases Decided by Court</h4>
                ...
                <form action="#" onsubmit="return Validation()" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Acquitted</label>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Convicted </label>
                    ...
                    <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Return </label>
                    ...
                    <div class="row">
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Imprisonment </label>
                          <input  id="s6"  class="form-control">
                          <span id="n6" class="text-danger"></span>
                        </div>
                      </div> 
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Fine Imposed Rs:</label>
