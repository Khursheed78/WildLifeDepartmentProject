      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">  License Renewal</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title"> Hunters License Information</h4>
                  ...
                  <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">License ID</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">License Holder</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                       <div class="col-md-4">
                         ...
                         <select name="select" id="select" class="form-control">
                        <option value="1">Please Select License Type</option>
                         <option value="1">Option #1</option>
                         <option value="2">Option #2</option>
                        <option value="3">Option #3</option>
                        </select>                    
                         ...
                         <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">License Nature</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
