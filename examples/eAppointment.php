            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Employee Initial Appointment</h4>
                ...
                <div class="card-body">
                  <form  action="#" onsubmit="return Validation()" method="post">
                    <div class="row">
                      ...
                      <div class="col-md-4 mt-4">
                        <div class="form-group">
                          ...
                          <input type="Date" class="form-control" id="s2">
                            <span id="n2" class="text-danger"></span>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <label class="control-label mb-1">Appointment Through</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Cader/Service Group</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Age of Retirement </label>
