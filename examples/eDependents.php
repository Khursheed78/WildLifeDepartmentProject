            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Employee Family information</h4>
                ...
                <div class="card-body">
                  <form action="#" onsubmit="return Validation()" method="post">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Dependent Name</label>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label >Date of Borth</label>
                            <input id="s2" type="Date" class="form-control">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Dependent Serial Number</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>WORLDLIFE</label>
                          <div class="form-group">
                            <label class="bmd-label-floating"> Khyber Pakhtunkhwa WildLife Act.2015</label>
                            <textarea id="s5" class="form-control" rows="5"></textarea>
 ...
 <!--  <div class="fixed-plugin">
  ...
  <script type="text/javascript">
    ...
    function  Validation()
    {
      ...
      document.getElementById('n3').innerHTML="* Please use only digit";
      return false;
