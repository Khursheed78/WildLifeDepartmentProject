            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Employee Qualification</h4>
                ...
                <div class="card-body">
                  <form action="#" method="post" onsubmit="return Validation()">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Grade/Division</label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Passing Year of Degree</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Last Institute</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Major Subject</label>
