            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Employee Training Information</h4>
                ...
                <div class="card-body">
                  <form action="#" method="post" onsubmit="return Validation()" >
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Trainig Serial Number</label>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Trainig Name</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Institute Address</label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Oblige Sponsor</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input id="s8" type="Date" class="form-control">
